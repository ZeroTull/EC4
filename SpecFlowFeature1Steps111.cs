...
namespace EC4_Automation_Tests
{
    ...
    public class EC4_Login_Logout
    {
        ...
        public void ThenIHaveSelectedDeskFromDeskSelectionCombobox(string desknumber)
        {
            And I have selected "Desk2001002" desk from desk selection combobox
            Thread.Sleep(3000);
            deskSelection.ComboBoxSelector(desknumber);
        } */
